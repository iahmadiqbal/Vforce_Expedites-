...
const Footer = () => (
  <footer className="text-foreground" style={{ backgroundColor: '#FEFCE8' }}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            {[
              ...
              <li key={l.path}>
                <Link to={l.path} className="text-foreground hover:text-accent transition-colors">
                  {l.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <div className="space-y-2 text-sm">
            ...
            <a href="https://www.google.com/maps/search/?api=1&query=21+Piggy+Place+St+John's+NL+A1B+3X2" target="_blank" rel="noopener noreferrer" className="flex items-start gap-2 text-foreground hover:text-accent transition-colors">
        ...
        <div>
          ...
          <div className="flex gap-3">
            <a
              ...
              className="w-9 h-9 rounded-full bg-foreground/10 flex items-center justify-center hover:bg-accent transition-colors text-foreground"
            >
              <Facebook size={16} />
            </a>
            <a
    ...
    <div className="border-t border-foreground/20">
      <div className="container-custom py-4 text-center text-sm text-foreground">
