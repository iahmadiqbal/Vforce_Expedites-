      ...
      <nav className="container-custom">
        <div className="flex items-center justify-between py-5">
          ...
          <div className="hidden lg:flex items-center gap-2 whitespace-nowrap flex-shrink-0">
            <a href={`tel:${PHONE_NUMBER}`} onClick={handleHelpClick} className="btn-accent text-sm py-2 px-3">
              <Phone size={16} />
              Immediate Help
            </a>
          </div>
          ...
          <div className="lg:hidden border-t border-border pb-4">
            <div className="py-4 space-y-1">
              ...
              <div className="pt-4 px-3 space-y-3">
                <a href={`tel:${PHONE_NUMBER}`} onClick={handleHelpClick} className="btn-accent text-sm py-2 px-4 w-full justify-center">
                  <Phone size={16} />
                  Immediate Help
                </a>
              </div>
